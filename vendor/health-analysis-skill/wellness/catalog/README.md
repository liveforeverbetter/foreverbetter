# Wellness Trait Catalog

Reference data for the wellness / lifestyle-relevant traits (nutrition, sleep, recovery) surfaced by the longevity-analysis pipeline. This is a condition-centric companion to the variant-centric files in `shared/interpretations/`.

## Files

- `PROVENANCE.md` 
- `catalog.json` — list of conditions in this wellness trait panel (id, name, slug)
...
const catalog = loadCatalog('wellness');
