...
| `dossier` | light | full multimodal healthspan dossier, composite index |
...
```json
{
  ...
  "scheme": "light",
  "colors": {
    "background": "#ffffff", "surface": "#f7f7f8", "surface_alt": "#eeeef0",
    "border": "rgba(0,0,0,0.10)", "text": "#111111", "text_muted": "#666666",
    "primary": "#3b5bdb", "on_primary": "#ffffff", "accent": "#12b3a6",
    "positive": "#16a34a", "warning": "#d97706", "negative": "#dc2626",
