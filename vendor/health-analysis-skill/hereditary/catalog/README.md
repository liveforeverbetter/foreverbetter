...
Reference data for the Mendelian / autosomal carrier conditions surfaced by the longevity-analysis pipeline. This is a condition-centric companion to the variant-centric files in `shared/interpretations/`.

## Files

- `PROVENANCE.md` 
- `catalog.json` — list of conditions in this monogenic disease panel (id, name, slug)
...
const catalog = loadCatalog('hereditary');
