# Personal Trait Catalog

Reference data for the personal cognitive, sensory, and behavioural traits surfaced by the longevity-analysis pipeline. This is a condition-centric companion to the variant-centric files in `shared/interpretations/`.

## Files

- `PROVENANCE.md` 
- `catalog.json` — list of conditions in this personal trait panel (id, name, slug)
...
const catalog = loadCatalog('personality');
