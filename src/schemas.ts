...
function responseSchemas(): Record<string, JsonSchema> {
  ...
  return {
    ...
    ActionPlan: {
      type: 'object', additionalProperties: false, required: ['analysis_id', 'user_id', 'generated_at', 'summary', 'interventions', 'supplements', 'cautions', 'evidence_key', 'sources', 'disclaimer', 'provenance'],
      properties: { analysis_id: { type: 'string' }, user_id: userId, organization_id: organizationId, generated_at: timestamp, summary: { type: 'string' }, interventions: { type: 'array', items: { type: 'object', additionalProperties: true } }, supplements: { type: 'array', items: { type: 'object', additionalProperties: true } }, cautions: stringArray, evidence_key: { type: 'object', additionalProperties: { type: 'string' } }, sources: { type: 'array', items: { type: 'object', additionalProperties: true } }, disclaimer: { type: 'string' }, provenance: { type: 'object', additionalProperties: true } },
    },
    HealthContext: {
